## Reset Service Hardening for Kiosk ##########

# Primary Author: OPSWAT
# Modified by: Stephen Turner
# Version: v4.0, 10/3/2022

### Require administrator privileges ###

### Allow Execution of Script ###

### You must execute this before running the script: Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass ###
...
echo Yes | REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Embedded\EmbeddedLogon" /v BrandingNeutral /t REG_DWORD /d 8 /f
echo Yes | REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System" /v dontdisplaylastusername /t REG_DWORD /d 1 /f

###Disable Services Tier 1 ###
#   Description:
# This script disables Windows services.
$services = @(
"AJRouter"
"AppReadiness"
"AppVClient"
...
# Services which CANNOT and SHOULD NOT be disabled
    #"ParagonAPFSMounter"
    #"ParagonLinuxFSMounter"
    #"ometascan"
    #"ometascan-node"
    #"ometascan-postgresql"
    #"MetadefenderSVC"
...
Function DisableDiagTrack {
	Write-Output "Stopping and Enabling Diagnostics Tracking Service..."
...
Function DisableWAPPush {
	Write-Output "Stopping and Enabling WAP Push Service..."
...
# Lower UAC level (Enabling it completely would break apps)
Function SetUACLow {
...
Function DisableHomeGroups {
	Write-Output "Stopping and Enabling Home Groups services..."
...
Function DisableSuperfetch {
	Write-Output "Stopping and Enabling Superfetch service..."
...
Function DisableIndexing {
	Write-Output "Stopping and Enabling Windows Search indexing service..."
...
Function DisableLockScreenRS1 {
	Write-Output "Enabling Lock screen using scheduler workaround..."
...
Function DisableThumbsDB {
	Write-Output "Enabling creation of Thumbs.db..."
